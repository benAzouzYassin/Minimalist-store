...
export default function MainDetails({ product }: Props) {
    return (
        <div className="grid grid-cols-2 gap-4  3xl:px-[250px] px-[200px] pt-10 ">
            ...
            <div className="bg-neutral-100 max-w-[650px] rounded-2xl pt-10 px-8">
                ...
                <p className="text-black/60 font-medium mt-2 ">
                    ...
                    defrosting, and with the perfect breadtoheater distance to
                    give crunchy toast with a soft, spongey middle.
                </p>

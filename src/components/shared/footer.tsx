...
export default function Footer() {
  return (
    <footer
      className="relative h-[265px] bg-black"
      style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)" }}
    >
      <div className="fixed pt-20   bottom-0   h-[265px] w-full text-white">
        ...
        <div className="w-full  text-lg mt-10 text-white/80 justify-center pl-5 flex items-center">
          <ul className="flex font-mono font-medium  items-center gap-8">
            <li>
